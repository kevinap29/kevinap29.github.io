...
<div class="container px-4 py-2">
	...
	<section class="py-4">
		...
		<div class="space-y-4">
			...
			<p>
				Pekerjaan utama saya sebagai <span class="font-bold">Admin CRM</span> adalah untuk merekap data semua penjualan dan service motor se Sumatera Selatan untuk dijadikan sebagai data leads (petunjuk) agar konsumen mau datang kembali hingga menjadi retensi.
			</p>
			<p>
				Setelah 1 tahun bekerja sebagai <span class="font-bold">Admin CRM</span>, Alhamdulillah saya mendapatkan pekerjaan yang saya inginkan yaitu menjadi <span class="font-bold">Web Programmer</span> di <span class="font-bold">PT. Ciptapapan Dinamika</span>. Disini saya perlu memperdalam ilmu saya lagi dikarenakan saya belum pernah menggunakan <span class="font-bold">C#, .NET Core dan SQL Server</span>. 
			</p>
		</div>
	</section>
</div>
