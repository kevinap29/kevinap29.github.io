...
<div class="max-w-3xl mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-[70vh]">
	<Reveal delay={100} y={40} class="w-full">
		...
		>
			<!-- Background Glow -->
			<div
				class="absolute -right-20 -top-20 size-64 rounded-none bg-primary/5 blur-3xl pointer-events-none"
			></div>
			<div
				class="absolute -left-20 -bottom-20 size-64 rounded-none bg-primary/5 blur-3xl pointer-events-none"
			></div>
			...
			<div class="relative z-10">
				...
				<div class="relative mb-8 flex items-center justify-center min-h-[150px]">
					<h1
						class="absolute inset-0 flex items-center justify-center text-[10rem] sm:text-[14rem] font-black tracking-tighter text-muted-foreground/5 select-none leading-none z-0"
					>
						{status}
					</h1>
					<h2
						class="relative z-10 text-3xl sm:text-5xl font-black uppercase tracking-tight text-foreground bg-background/50 backdrop-blur-sm px-6 py-2 border-y border-primary/10"
					>
				...
				<div class="flex flex-col sm:flex-row items-center justify-center gap-4">
					<Button
						href="/"
						class="rounded-none h-12 px-8 font-black uppercase tracking-widest text-xs shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all w-full sm:w-auto"
					>
